...
const CATEGORY_TAXONOMY = {
  ...
  toys: {
    label: '公仔',
    /* 老闆 2026-09-02：「卡通角色貨 公仔類別」——
       所以呢格唔止盲盒同毛絨，Sanrio 護手霜、蠟筆小新唇膏、吉伊卡哇噴霧
       嗰啲聯乘美妝一樣要入嚟。佢哋唔會因為咁而離開原本嗰格（分區唔係
       互斥嘅）—— 客想搵護手霜就喺護手霜度搵得到，想睇大耳狗就喺公仔度
       睇得晒，兩邊都成立。
       用 `卡通角色` 做 tag 而唔係 `公仔`：`公仔` 會中埋 `plush` 嗰個子分類，
       一支護手霜擺喺「毛絨公仔」入面就錯咗。 */
    keywords: ['公仔', '盲盒', '毛絨', '掛件', '匙扣', '扭蛋', '玩具', '卡通角色'],
    subs: {
      blindbox:  { label: '盲盒',     keywords: ['盲盒', '扭蛋'] },
      plush:     { label: '毛絨公仔', keywords: ['毛絨', '公仔'] },
      charm:     { label: '掛件匙扣', keywords: ['掛件', '匙扣', '掛繩'] },
      character: { label: '角色美妝', keywords: ['卡通角色'] },
    },
  },
  fragrance: {
    label: '香水香氛',
